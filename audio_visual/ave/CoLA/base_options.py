...
class BaseOptions():
	...
	def initialize(self):
		self.parser.add_argument(
			"--working_dir", type=str, default='/path/to/AVE/working_dir/', help="working_dir dir")
		self.parser.add_argument(
		...
		self.parser.add_argument(
			"--checkpoint", type=str, default='ave_model',
		...
		### for AV-ada ###
		self.parser.add_argument('--audio_folder', type=str, default="/path/to/AVE_Dataset/raw_audio/", help="raw audio path")
		self.parser.add_argument('--video_folder', type=str, default="/path/to/AVE_Dataset/video_frames/", help="video frame path")
		...
		self.parser.add_argument('--vis_encoder_type', type=str, default="vit_b", help="type of visual backbone")
		self.parser.add_argument('--use_lora',  default=True, action='store_true', help='Apply LoRA to the model') 
		self.parser.add_argument('--lora_r', default=16, type=int, help='LoRA rank')
		self.parser.add_argument('--lora_alpha', default=8, type=int, help='LoRA alpha')	
		self.parser.add_argument('--lora_c_scaling', default=0.1, type=float, help='LoRA alpha')	
		self.parser.add_argument('--lora_reduction', default=16, type=int, help='LoRA alpha')
		self.parser.add_argument('--accum_itr', default=2, type=int, help='Grad Accumulation steps')
		self.parser.add_argument('--sslam_norm',  type=int, default=0,  help='For SSLAM use its pre-trained norm stats') 

		self.parser.add_argument('--checkpoint_weight', type=str, default="maxvit_sep", help="type of visual backbone")
