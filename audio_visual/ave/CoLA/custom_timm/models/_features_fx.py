...
from custom_timm.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame
from custom_timm.layers.non_local_attn import BilinearAttnTransform
from custom_timm.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
from custom_timm.layers.norm_act import (
    BatchNormAct2d,
    SyncBatchNormAct,
...
try:
    from custom_timm.layers import InplaceAbn
...
def register_notrace_module(module: Type[nn.Module]):
    """
    Any module not under custom_timm.models.layers should get this decorator if we don't want to trace through it.
    """
