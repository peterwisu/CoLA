...
# DATA
cfg.DATA = edict()
cfg.DATA.ANNO_CSV = "/path/to/avsbench_data/Single-source/s4_meta_data.csv"
cfg.DATA.DIR_IMG = "/path/to/avsbench_data/Single-source/s4_data/visual_frames"
cfg.DATA.DIR_AUDIO_LOG_MEL = "/path/to/avsbench_data/Single-source/s4_data/audio_log_mel"
cfg.DATA.DIR_AUDIO_WAV = "/path/to/avsbench_data/Single-source/s4_data/audio_wav"
cfg.DATA.DIR_MASK = "/path/to/avsbench_data/Single-source/s4_data/gt_masks"
