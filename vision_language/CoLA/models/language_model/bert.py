...
class BERT(nn.Module):
    def __init__(self, name: str, train_bert: bool, hidden_dim: int, max_len: int, enc_num, bb_ckpt_dir: str, use_lora: bool, lora_r: int, lora_alpha: int, do_fusion : List, c_features : int):
        super().__init__()
