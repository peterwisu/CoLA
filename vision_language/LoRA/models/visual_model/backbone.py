...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str, bb_ckpt_dir: str = None, use_lora: bool = False, use_lora_r: int = 8, use_lora_alpha: int = 8):
        ...
        if name == 'SwinT':
            ...
            backbone = build_ViTDet(use_lora, use_lora_r, use_lora_alpha)
...
def build_backbone(args):
    ...
    backbone = Backbone(args.backbone, args.bb_ckpt_dir, args.use_lora, args.lora_r, args.lora_alpha)
